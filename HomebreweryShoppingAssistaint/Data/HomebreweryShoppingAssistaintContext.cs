...
namespace HomebreweryShoppingAssistaint.Data
{
    public class HomebreweryShoppingAssistaintContext : DbContext
    {
        ...
        public DbSet<HomebreweryShoppingAssistaint.Models.ProductCheckHistory> ProductCheckHistory { get; set; } = default!;

        public DbSet<HomebreweryShoppingAssistaint.Models.ShopCheckHistory> ShopCheckHistory { get; set; } = default!;
    }
}
